...
const Trabalhos = () => {
    return (
        <>
            ...
            <title>Trabalhos - Marcos Tavares Desenvolvedor Fullstack</title>
            ...
            <meta property="og:title" content="Trabalhos - Marcos Tavares Fullstack" />
            ...
            <meta property="og:url" content="https://marcostavares.dev.br/trabalhos" />
            <meta property="og:site_name" content="Marcos Tavares FullStack" />
            <meta property="article:publisher" content="https://www.facebook.com/marcostavares.dev" /> <title>Trabalhos - Marcos Tavares Desenvolvedor Fullstack</title>
            <meta name="description" content="Marcos Tavares, desenvolvedor fullstack especializado em JavaScript. Dê vida às suas ideias com soluções digitais inteligentes. Desenvolvo aplicações robustas, escaláveis e intuitivas que unem design e funcionalidade para entregar excelência e resultados." />
        </>
    );
};
